    ...
    <div class="body-content">
        <form method="post" class="form-x" action="<%=basePath%>roleController/addRole.do">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="${role.roleDesc}" name="roleDesc" data-validate="required:请输入标题"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="${role.roleState}" name="roleState" data-validate="required:请输入标题"/>
                    <div class="tips"></div>
                </div>
            </div>
